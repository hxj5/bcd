...
if __name__ == "__main__":
    run_starsolo(
        bam_fn = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/cs_benchmark/composition/mixed/simu/4_rs/bam/rs.possorted.bam",
        genome_dir = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/base/data/refseq/star/genome_index",
        cb_whitelist_fn = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/cs_benchmark/composition/mixed/rdr_starsolo/starsolo.barcodes.pseudo_whitelist.tsv",
        out_dir = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/cs_benchmark/composition/mixed/rdr_starsolo",
        ncores = 10,
        read_file_type = 'SAM SE',
        read_file_command = 'samtools view -F 0x100',
        solo_strand = 'Forward',
        ...
        solo_umi_len = 12,
        out_sam_type = 'BAM Unsorted',
        script_fn = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/cs_benchmark/composition/mixed/rdr_starsolo/scripts/run_star.sh"
    )
