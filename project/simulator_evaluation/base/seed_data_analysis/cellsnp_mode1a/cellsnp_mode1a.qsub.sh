...
/usr/bin/time -v  cellsnp-lite  \
    -s  /groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/base/data/bam/HCC3N_600spot.possort.bam   \
    ...
    -O  /groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/base/gen_data/seed/cellsnp_mode1a  \
    -p  20  \
    --minCOUNT  0  \
    --minMAF  0    \
    --gzip
