# scdesign2_copula_gen_data.R - Simulate new count matrix with scDesign2 'copula' mode.
...
out_dir = "/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/simulator_evaluation/base/gen_data/afc_scdesign2_copula/simu"
out_fn_prefix = 'scDesign2_copula'
sim_method = 'copula'
