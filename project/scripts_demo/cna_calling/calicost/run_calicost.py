...
def run_calicost(
    ...
    if not skip_purity:
        ...
        with open(config_purity_fn, "w") as fp:
            ...
            fp.write("secondary_min_umi : 400\n")
        ...
        script_purity_fn = os.path.join(script_dir, "calicost.purity.sh")
        s  = '''#!/bin/bash\n'''
        ...
        s += '''OMP_NUM_THREADS=1\n'''
        s += '''\n'''
        s += '''python %s  \\\n''' % os.path.join(calicost_dir, "src/calicost/estimate_tumor_proportion.py")
        s += '''    -c  %s\n''' % config_purity_fn
        s += '''\n'''
        s += '''echo "[CalicoST Purity] All Done!"\n'''
        s += '''\n'''
        ...
        cmd = "/usr/bin/time -v %s" % script_purity_fn
        ret, outs, errs = run_cmd(cmd)
        if ret != 0:
            return(ret)
...
if __name__ == "__main__":
    run_calicost(
        ...
        out_dir = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1n1t_s1600/downsample_coverage/ds_50perc/cna_calling/calicost',
        ncores = 10,
        genome = 'hg38',
        ...
        bam_fn = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1n1t_s1600/downsample_coverage/ds_50perc/gen_data/ps_spaceranger/possorted_genome_bam.bam',
        spaceranger_dir = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1n1t_s1600/downsample_coverage/ds_50perc/gen_data/ps_spaceranger',
        bamlist = None,
        normalidx_file = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1n1t_s1600/downsample_coverage/ds_50perc/gen_data/ps_spaceranger/normalidx_file.tsv',
        tumorprop_file = None,
        script_dir = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1n1t_s1600/downsample_coverage/ds_50perc/cna_calling/calicost/scripts'
    )
