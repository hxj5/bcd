...
if __name__ == "__main__":
    run_infercnv(
        ...
        matrix_dir = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1r1n1t/vary_tumor_prop/analysis/infercnv_hepatocyte-ref/as_ref/gen_data',
        out_dir = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1r1n1t/vary_tumor_prop/analysis/infercnv_hepatocyte-ref/as_ref/infercnv',
        cell_anno_fn = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1r1n1t/vary_tumor_prop/analysis/infercnv_hepatocyte-ref/as_ref/gen_data/cell_anno.tsv',
        ref_cell_types = 'hepatocyte',
        gene_anno_fn = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/base/data/refapp/infercnv/infercnv.genes.tsv',
        ncores = 10,
        cutoff = 0.1,
        png_dpi = 300,
        script_fn = '/groups/cgsd/xianjie/projects/cna-benchmark/HCC3N_600spot/cna_prediction/1r1n1t/vary_tumor_prop/analysis/infercnv_hepatocyte-ref/as_ref/infercnv/scripts/run_infercnv.R'
    )
